...
public class apiAdapter {
    public static void main(String args[]){
        ...
        filter.add("anki");
        APKInfoExtractor extractor2 = new APKInfoExtractor(apkPath1,filter);
        writeAPK("oldAPK.txt",extractor2.getAPK());
//        MyAPK myAPK = readAPK("newAPK.txt");
//        List<MyMethod> myMethods = myAPK.getMyMethods();
//        for(MyMethod myMethod : myMethods){
//            if(myMethod.getMethodName().contains("getSharedPrefs")){
//                System.out.println(myMethod.getSignature());
//            }
//        }

//        List<MyClass> myClasses = myAPK.getMyClasses();
//        for(MyClass myClass : myClasses){
//            if(myClass.getName().contains("AnkiDroidApp")){
//                System.out.println(myClass.getName());
//            }
//        }

        String oldAPIPath = "C:/Users/17916/Desktop/APIGenerate/AnkiDroid/Instances/addItem/addItem.json";
        apiAdapter(oldAPIPath,"oldAPK.txt","newAPK.txt");
//        reckonMethodSimilarity("oldAPK.txt","newAPK.txt");
    }

    private static void apiAdapter(String oldAPIPath,String oldAPKPath,String newAPKPath){
...
//                        invokeCall.replace(entry.getKey(),entry.getValue());
        ...
        MyFileUtil.writeJSONObject("execute.txt",oldAPI);
    }
